...
import net.nm_weapons_pack.items.weapons.helpers.NmThrowableWeaponEntityModel;

@Environment(EnvType.CLIENT)
public class NmTridentEntityModel extends NmThrowableWeaponEntityModel {
    public NmTridentEntityModel(ModelPart root) {
        super(root);
    }
